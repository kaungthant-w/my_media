        ...
        <div class="card-body">
            <form action="{{route('admin#categoryUpdate', $UpdateData['category_id'])}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="categoryDescription" class="form-control" placeholder="Enter description">{{old('categoryDescription', $UpdateData['description'])}}</textarea>
                ...
                <a href="{{route('admin#category')}}" type="button" class="btn btn-outline-info">Create</a>
            </form>
        </div>
    </div>
</div>
